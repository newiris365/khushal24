...
export default function Footer() {
  return (
    <footer className="bg-[#050010] dark:bg-[#050010] light:bg-slate-100 text-slate-400 border-t border-[#8A2BE2]/20 dark:border-[#8A2BE2]/20 light:border-slate-200 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          {/* Brand Info */}
          <div className="lg:col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl overflow-hidden shrink-0 border border-[#8A2BE2]/30">
                <Image
                  src="/icon-192.png"
                  alt="IRIS 365"
                  width={40}
              ...
              <span className="font-heading font-extrabold text-2xl tracking-tight text-white dark:text-white light:text-slate-900">
                IRIS<span className="text-purple-400 font-mono">365</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-3 pt-2">
              <ThemeToggle />
              <span className="text-xs text-slate-400 font-mono">Select Appearance Mode</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link href="/request-demo" className="hover:text-purple-300 transition-colors">
